CREATE OR REPLACE VIEW core.v_client_daily_history AS
WITH client_daily AS (
    SELECT
        ...
        SUM(CASE WHEN is_due_in_3_days AND NOT is_due_today THEN invoice_amount ELSE 0 END) AS due_soon_only,
