...
@ui.page("/term-shifts", response_timeout=get_page_response_timeout())
@page_build("term_shifts", "/term-shifts")
async def term_shifts_page():
    ...
    branches = await query_df("""
        ...
        ORDER BY
            ...
            term_shift_count DESC,
            total_debt DESC
    """, operation="term_shifts_branches")
