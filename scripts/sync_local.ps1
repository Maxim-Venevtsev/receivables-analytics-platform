...
Write-Host ""
Write-Host "============================================"
Write-Host " Debt Management BI - Local Sync"
Write-Host "============================================"
Write-Host ""
...
if ($null -eq $agent -or $agent.Status -ne "Running") {
    ...
    Write-Host "Start it from an administrator PowerShell:"
...
& $PythonExe -m src.automation.local_sync.cli --order oldest
