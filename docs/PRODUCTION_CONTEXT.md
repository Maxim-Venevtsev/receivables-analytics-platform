...
Separate secured deployment for real operational usage is planned.
...
demo / production environment separation
...
The client queue supports operational prioritization and collection workflow management.
...
The next development stage includes migration from demo datasets to real operational receivables exports with:

full branch structure
daily real ERP exports
